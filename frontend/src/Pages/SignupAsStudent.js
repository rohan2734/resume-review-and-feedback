...
//css
import styles from "./SignupAsStudent.module.css";
    ...
    return (
        <div className={styles.container__parent}>
            <div className={styles.container}>
                <h1 className={styles.container__title}>Signup as Student</h1>
                <h3 className={styles.container__subtitle}>signup,Upload your resume and get experts review</h3>
                ...
                {/* <div className={styles.inputs}> */}
                    ...
                    {/* <div className={styles.}></div> */}
                        ...
                        <button className={styles.container__submit} type="submit" >signup as student</button>
                    </form>
                {/* </div> */}
                <h4 className={styles.container__subtitle}>Already have an account? <Link to="/login-as-student">Login as Student</Link> </h4>
